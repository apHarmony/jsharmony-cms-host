...
WebConnect.prototype.reqjson = function (url, method, post, headers, ftarget, callback, reqoptions) {
...
WebConnect.prototype.req = function (url, method, post, headers, ftarget, callback, reqoptions) {
  ...
  var req = browser.request(options, function (res) {
    ...
    if((res.statusCode == 301) || (res.statusCode == 302)){
      ...
      if(redirectUrl.indexOf('//')==0){ /* Do nothing */ }
      else if(redirectUrl.indexOf('://')==0){ /* Do nothing */ }
  ...
  req.on('timeout', function() {
    if(!returned){
      req.abort();
      returned = true;
      if (callback) callback('Timeout', null, null);
    }
  });
